    ...
    <div>
      <div
        ...
        className={conditions(
          "h-14 w-12 hover:bg-black hover:text-white transition-all cursor-pointer border text-sm grid grid-cols-2 border-spacing-1 sm:border p-1 lg:p-2 sm:h-15 sm:w-14 lg:h-20 lg:w-28",
