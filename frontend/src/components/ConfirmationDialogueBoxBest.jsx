...
export default function ConfirmationDialogueBoxBest({ sessionId }) {
  ...
  return (
    <>
      <button
        type="button"
        className="focus:outline-none text-white bg-light-blue-700 bg hover:bg-cyan-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 m-1 sm:m-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
